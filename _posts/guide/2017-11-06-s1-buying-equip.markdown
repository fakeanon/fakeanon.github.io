...
* \***Тканевый пластырь** пластырь также нужен для изготовления тампона для банок[^7], рекомендую в рулончиках и потоньше. Можно заменить изолентой на тканевой основе.
